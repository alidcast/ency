...
function Subscription (observer, subscriber) {
  ...
  try {
    ...
    if (cleanup != null) {
      if (typeof cleanup.unsubscribe === 'function') cleanup = cleanupFromSubscription(cleanup)
      else if (typeof cleanup !== 'function') throw new TypeError(cleanup + ' is not a function')
